...
$select_expartise = "SELECT * FROM expartis ";
$select_expartise_res = mysqli_query($db_connect, $select_expartise );
// $after_assoc_expartise= mysqli_fetch_assoc($select_expartise_res);
// <?php foreach($select_expartise as $skill){ 
...
$select_port_res = mysqli_query($db_connect, $select_port );


// masage

$select_port = "SELECT * FROM masages";
$select_port_res = mysqli_query($db_connect, $select_port );


//testimonial

$select_testmonial = "SELECT * FROM testimonials";
$select_testimonial_res = mysqli_query($db_connect, $select_testmonial );
...
<nav class="navbar navbar-expand-lg bg-transprent py-4 fixed-top navigation" id="navbar">
	<div class="container">
	  <a class="navbar-brand" href="index.html">
	  	<img width="100" src="upload/logo/<?php echo $after_assoc_logo['header_logo'] ?>" alt="">
	  </a>
		...
		<div class="row align-items-center">
			<div class="col-lg-5 col-sm-12 col-12 col-md-5">
				<div class="slider-img position-relative">
					<img src="upload/about/<?= $after_assoc_about['image']?>" alt="" class="img-fluid w-100">
				</div>
			</div>

			<div class="col-lg-6 col-12 col-md-7">
				<div class="ml-5 position-relative mt-5 mt-lg-0">
					<span class="head-trans"><?= $after_assoc_about['nick_name']?></span>
					...
					<p class="animated fadeInUp lead mt-4 mb-5 text-white-50 lh-35"><?= $after_assoc_about['short_desp']?></p>
...
<section class="section bg-gray" id="skillbar" data-aos="fade-up">
	<div class="container">
		...
		<div class="row">
			<?php foreach($select_expartise_res as $skill) { ?>
			...
			<div class="post_gallery owl-carousel owl-theme">
				<div class="item">
					<div class="portfolio-item position-relative">
						<img src="upload/portfolio/portfolio.10717.jpg" alt="" class="img-fluid">
				...
				<div class="item">
					<div class="portfolio-item position-relative">
						<img src="upload/portfolio/portfolio.11514.jpg" alt="" class="img-fluid">
				...
				<div class="item">
					<div class="portfolio-item position-relative">
						<img src="upload/portfolio/portfolio.15091.jpg" alt="" class="img-fluid">
				...
				<div class="item">
					<div class="portfolio-item position-relative">
						<img src="upload/portfolio/portfolio.15829.jpg" alt="" class="img-fluid">
				...
				<div class="item">
					<div class="portfolio-item position-relative">
						<img src="upload/portfolio/portfolio.17025.jpg" alt="" class="img-fluid">
				...
				<div class="item">
					<div class="portfolio-item position-relative">
						<img src="upload/portfolio/portfolio.18999.jpg" alt="" class="img-fluid">
						...
						<div class="testimonial-item position-relative">
							...
							<div class="testimonial-content">
								...
								<div class="media mt-5 align-items-center">
									<img src="upload/tesmonial/tesmonial.17323.png" alt="" class="img-fluid  rounded-circle align-self-center mr-4">
	...
	<div class="container">
		...
		<div class="row justify-content-center">
          ...
          <?php } unset($_SESSION['exit']) ?>
					...
					<form class="contact__form form-row contact-form" method="POST" action="masage_POSt.php">
						<div class="row">
									<div class="col-12">
							...
							<div class="form-group col-lg-6 mb-5">
						      <input type="text" id="name" name="name" style="border-color:<?=(isset( $_SESSION['name_err'])?'red':'') ?>;" class="form-control bg-transparent" placeholder="Your Name">
								<?php if (isset( $_SESSION['name_err'])){?>
                        <strong class='text-danger'> <?= $_SESSION['name_err']?> </strong>
                        <?php } unset( $_SESSION['name_err'])?>
					     </div>
					    <div class="form-group col-lg-6 mb-5">
						      <input type="text" name="email" id="email" style="border-color:<?=(isset( $_SESSION['name_err'])?'red':'') ?>;" class="form-control bg-transparent" placeholder="Your Email">
					  ...
					  <div class="form-group col-lg-12 mb-5">
						     <input type="text" name="subject" id="subject" style="border-color:<?=(isset( $_SESSION['subject'])?'red':'') ?>;" class="form-control bg-transparent" placeholder="Your Subject">
							  <?php if (isset( $_SESSION['subject'])){?>
                       <strong class='text-danger'> <?= $_SESSION['subject']?> </strong>
					...
					<div class="form-group col-lg-12 mb-5">
                     ...
                     <strong class='text-danger'> <?= $_SESSION['messsage']?> </strong>
                  <?php } unset( $_SESSION['messsage'])?>	
					</div>		
...
<footer class="footer border-top-1">
	<div class="container">
		<div class="row align-items-center text-center text-lg-left">
			<div class="col-lg-2">
			<img width="100" src="upload/logo/<?php echo $after_assoc_logo['footer_logo'] ?>" alt="">
			</div>
			<div class="col-lg-10">
...
<!-- Footer End -->
    ...
    <script src="js/ajax-contact.html"></script>
	 ...
	 <script>
		alert("<?=isset($_SESSION['success']) ? $_SESSION['success']: ""; ?>");
	 </script>
	<?php }
